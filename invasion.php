...
<body>
  ...
  <section class='content'>
    <article>
      <h2>Invasão | Vídeo exclusivo mostra bastidores da 2ª temporada</h2>
      <sup>Autor: Beltrano Rodrigues</sup>
    </article>
    <p>
      <img src="./assets/img/invasaoImage.webp" alt="">
  ...
  <section class='containerComments'>
    ...
    <ul>
      ...
      <li>
        ...
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Tenetur exercitationem placeat quaerat ab explicabo distinctio. Numquam, alias id. Omnis repudiandae voluptatibus, dicta amet optio sed? Labore expedita unde error itaque.
        </p>
        <div class="btnLikes">
          <abbr title="Gostei"><img class="like" src="./assets/img/btnLike.svg" alt=""></abbr>
          <abbr title="Nao Gostei"><img class="dislike" src="./assets/img/btnLike.svg" alt=""></abbr>
